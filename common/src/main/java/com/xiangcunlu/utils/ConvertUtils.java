...
public class ConvertUtils {
    ...
    private static final char[] aUnit = {'分', '角'};
    ...
    public static void main(String[] args) {
        System.out.println(ConvertUtils.convertToMoney("123456789.01"));
        System.out.println(ConvertUtils.convertToMoney("100006789.01"));
        System.out.println(ConvertUtils.convertToMoney("12.12"));
    }
